...
- It does not provide a Node/bundler React environment. React/JSX only works through in-browser UMD + Babel standalone patterns in the canvas (not a real bundler toolchain).
